...
asr_config=conf/tuning/train_asr_transformer_16M_baseline_resume.yaml
...
./asr.itp.sh \
    --lang en \
    --ngpu 8 \
    --asr_tag "swap_embedding_baseline" \
    --init_param "/blob/tsst/users/v-weiwang1/espnet/egs2/librispeech/exp/?/valid.acc.ave.pth" \
    --nbpe 10000 \
    --max_wav_duration 30 \

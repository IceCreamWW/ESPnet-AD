...
if ! "${skip_train}"; then
    ...
    if [ ${stage} -le 10 ] && [ ${stop_stage} -ge 10 ]; then
        ...
        ${python} -m espnet2.bin.asr_train_mtl \
            ...
            --train_shape_file_and_loader "${_logdir}/train.speech.1.scp",speech \
            --train_shape_file_and_loader "${_logdir}/train.text.1.scp",text \
            --valid_shape_file_and_loader "${_logdir}/valid.1.scp",speech_valid \
            --output_dir "${_logdir}/stats.JOB" \
